...
```go
import "github.com/MacgradyHuang/TarsGo/tars/util/zaplog"

zaplog.Debug("Debug logging")
```

如果你想设置日志等级，你可以在Tencent/Tars/web下的tars项目提供的OSS平台上设置它。
如果你想自定义你的日志，请在tars/zaplogger.go中的查看更多细节。
### 5  服务管理
...
```go
import "github.com/MacgradyHuang/TarsGo/tars"
...
